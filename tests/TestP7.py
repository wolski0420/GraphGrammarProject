...
class TestP7(unittest.TestCase):
    def test_match_P7_correct(self):
        ...
        e8 = base_graph.add_vert(pos_x=0, pos_y=4, level=pevel_prev, label="E")
        base_graph.add_edges([(e7, i1), (e7, i2), (e8, i1), (e8, i2)])
        ...
        i1 = expected_graph.add_vert(pos_x=-4, pos_y=0, level=pevel_prev, label="i")
        i2 = expected_graph.add_vert(pos_x=4, pos_y=0, level=pevel_prev, label="i")
        ...
        e7 = expected_graph.add_vert(pos_x=0, pos_y=-4, level=pevel_prev, label="E")
        e8 = expected_graph.add_vert(pos_x=0, pos_y=4, level=pevel_prev, label="E")
        expected_graph.add_edges([(e7, i1), (e7, i2), (e8, i1), (e8, i2)])
    ...
    def test_match_P7_correct_rotated(self):
        ...
        prev_level = level-1
        base_graph = StandardizedGraph()
        i1 = base_graph.add_vert(pos_x=0, pos_y=-4, level=prev_level, label="i")
        i2 = base_graph.add_vert(pos_x=0, pos_y=4, level=prev_level, label="i")
        I1 = base_graph.add_vert(pos_x=2, pos_y=-2, level=level, label="I")
        I2 = base_graph.add_vert(pos_x=-2, pos_y=-2, level=level, label="I")
        I3 = base_graph.add_vert(pos_x=2, pos_y=2, level=level, label="I")
        I4 = base_graph.add_vert(pos_x=-2, pos_y=2, level=level, label="I")
        ...
        base_graph.add_edges([(I1, e4), (I1, e5), (I2, e6), (I2, e5), (I3, e1), (I3, e2), (I4, e2), (I4, e3)])
        base_graph.add_edges([(e4, e5), (e6, e5), (e1, e2), (e2, e3)])
        e7 = base_graph.add_vert(pos_x=0, pos_y=0, level=prev_level, label="E")
        ...
        expected_graph = StandardizedGraph()
        i1 = expected_graph.add_vert(pos_x=0, pos_y=-4, level=prev_level, label="i")
        i2 = expected_graph.add_vert(pos_x=0, pos_y=4, level=prev_level, label="i")
        I1 = expected_graph.add_vert(pos_x=2, pos_y=-2, level=level, label="I")
        I2 = expected_graph.add_vert(pos_x=-2, pos_y=-2, level=level, label="I")
        I3 = expected_graph.add_vert(pos_x=2, pos_y=2, level=level, label="I")
        I4 = expected_graph.add_vert(pos_x=-2, pos_y=2, level=level, label="I")
        ...
        expected_graph.add_edges([(I1, e1), (I1, e2), (I2, e3), (I2, e2), (I3, e1), (I3, e2), (I4, e2), (I4, e3)])
        expected_graph.add_edges([(e1, e2), (e2, e3)])
        e7 = expected_graph.add_vert(pos_x=0, pos_y=0, level=prev_level, label="E")
        expected_graph.add_edges([(e7, i1), (e7, i2)])
    ...
    def test_match_P7_incorrect_pos(self):
        ...
        i_match_list = match_P7(base_graph, level)
        self.assertEqual(i_match_list, [])
    ...
    def test_match_P7_correct_large(self):
        ...
        level_prev = level - 1
        base_graph = StandardizedGraph()
        i1 = base_graph.add_vert(pos_x=-4, pos_y=2, level=level_prev, label="i")
        i2 = base_graph.add_vert(pos_x=4, pos_y=2, level=level_prev, label="i")
        ...
        e13 = base_graph.add_vert(pos_x=0, pos_y=0, level=level_prev, label="E")
        base_graph.add_edges([(e13, i1), (e13, i2)])

        i3 = base_graph.add_vert(pos_x=-4, pos_y=-2, level=level_prev, label="i")
        i4 = base_graph.add_vert(pos_x=4, pos_y=-2, level=level_prev, label="i")
        ...
        e14 = base_graph.add_vert(pos_x=0, pos_y=-1, level=level_prev, label="E")
        base_graph.add_edges([(e14, i3), (e14, i4)])
        ...
        options = match_P7(base_graph, level)
        i_match0, i_match1 = options[0]
        new_graph = P7(base_graph, i_match0, i_match1)

        expected_graph = StandardizedGraph()
        i1 = expected_graph.add_vert(pos_x=-4, pos_y=2, level=level_prev, label="i")
        i2 = expected_graph.add_vert(pos_x=4, pos_y=2, level=level_prev, label="i")
        ...
        e13 = expected_graph.add_vert(pos_x=0, pos_y=0, level=level_prev, label="E")
        expected_graph.add_edges([(e13, i1), (e13, i2)])

        i3 = expected_graph.add_vert(pos_x=-4, pos_y=-2, level=level_prev, label="i")
        i4 = expected_graph.add_vert(pos_x=4, pos_y=-2, level=level_prev, label="i")
        ...
        e7 = expected_graph.add_vert(pos_x=0, pos_y=0, level=level, label="E")
        ...
        e10 = expected_graph.add_vert(pos_x=0, pos_y=0, level=level, label="E")
        ...
        e14 = expected_graph.add_vert(pos_x=0, pos_y=-1, level=level_prev, label="E")
        expected_graph.add_edges([(e14, i3), (e14, i4)])
        ...
        expected_graph.add_edges([(I5, e7), (I5, e8), (I6, e8), (I6, e9),  (I7, e10),(I7, e11), (I8, e12), (I8, e11)])
        expected_graph.add_edges([(e1, e2), (e2, e3), (e7, e8), (e8, e9),  (e10, e11), (e11, e12)])
    ...
    def test_match_P7_correct_too_much(self):
        ...
        e2 = base_graph.add_vert(pos_x=0, pos_y=0, level=level, label="E")
        e3 = base_graph.add_vert(pos_x=0, pos_y=-4, level=level, label="E")
        e3_1 = base_graph.add_vert(pos_x=0, pos_y=-8, level=level, label="E")
        e4 = base_graph.add_vert(pos_x=0, pos_y=4, level=level, label="E")
        e5 = base_graph.add_vert(pos_x=0, pos_y=0, level=level, label="E")
        e6 = base_graph.add_vert(pos_x=0, pos_y=-4, level=level, label="E")
        e6_1 = base_graph.add_vert(pos_x=0, pos_y=-8, level=level, label="E")
        base_graph.add_edges([(i1, I1), (i1, I2), (i2, I3), (i2, I4)])
        ...
        e2 = expected_graph.add_vert(pos_x=0, pos_y=0, level=level, label="E")
        e3 = expected_graph.add_vert(pos_x=0, pos_y=-4, level=level, label="E")
        e3_1 = expected_graph.add_vert(pos_x=0, pos_y=-8, level=level, label="E")
        e6_1 = expected_graph.add_vert(pos_x=0, pos_y=-8, level=level, label="E")
        expected_graph.add_edges([(i1, I1), (i1, I2), (i2, I3), (i2, I4)])
        ...
        e13 = expected_graph.add_vert(pos_x=0, pos_y=1, level=prev_level, label="E")
        expected_graph.add_edges([(e13, i1), (e13, i2)])
    ...
    def test_match_P7_incorrect_too_much(self):
        level = 1
        prev_level = level - 1
        base_graph = StandardizedGraph()
        i1 = base_graph.add_vert(pos_x=-4, pos_y=0, level=prev_level, label="i")
        ...
        e1 = base_graph.add_vert(pos_x=0, pos_y=4, level=level, label="E")
        e2 = base_graph.add_vert(pos_x=0, pos_y=0, level=level, label="E")
        e3 = base_graph.add_vert(pos_x=0, pos_y=-6, level=level, label="E")
        e3_1 = base_graph.add_vert(pos_x=0, pos_y=-8, level=level, label="E")
        e4 = base_graph.add_vert(pos_x=0, pos_y=4, level=level, label="E")
        e5 = base_graph.add_vert(pos_x=0, pos_y=0, level=level, label="E")
        e6 = base_graph.add_vert(pos_x=0, pos_y=-6, level=level, label="E")
        e6_1 = base_graph.add_vert(pos_x=0, pos_y=-8, level=level, label="E")
        base_graph.add_edges([(i1, I1), (i1, I2), (i2, I3), (i2, I4)])
        base_graph.add_edges([(I1, e4), (I1, e5), (I2, e6), (I2, e5), (I3, e1), (I3, e2), (I4, e2), (I4, e3), (I4, e3_1), (I2, e6_1)])
        base_graph.add_edges([(e4, e5), (e6, e5), (e1, e2), (e2, e3), (e3_1, e3), (e6, e6_1)])
        ...
        i_match0 = match_P7(base_graph, level)

        self.assertEqual(i_match0, [])

    def test_match_P8_incorrect(self):
        level = 1
        prev_level = level-1
        base_graph = StandardizedGraph()
        i1 = base_graph.add_vert(pos_x=-4, pos_y=0, level=prev_level, label="i")
