...
class TestP13(unittest.TestCase):
    def test_match_P13_correct(self):
        level = 1
        prev_level = level-1
        ...
        base_graph.add_edges([(i1, I1), (i2, I3)])
        base_graph.add_edges([(I1, e1), (I1, e5),  (I3, e1), (I3, e2)])
        base_graph.add_edges([(e1, e5),  (e1, e2),])
        ...
        i_match0, i_match1 = match_P13(base_graph, level)[0]

        new_graph = P13(base_graph, i_match0, i_match1)
        ...
        expected_graph.add_edges([(i1, I1), (i2, I3)])
        expected_graph.add_edges([(I1, e1), (I1, e2), (I3, e1), (I3, e2)])
        expected_graph.add_edges([(e1, e2)])
    ...
    def test_match_P8_correct_rotated(self):
        level = 1
        prev_level = level - 1
        base_graph = StandardizedGraph()
        i1 = base_graph.add_vert(pos_x=-4, pos_y=0, level=prev_level, label="i")
    ...
    def test_match_P8_incorrect_pos(self):
        level = 1
        prev_level = level - 1
        base_graph = StandardizedGraph()
        i1 = base_graph.add_vert(pos_x=-4, pos_y=0, level=prev_level, label="i")
    ...
    def test_match_P8_incorrect_missing(self):
        level = 1
        prev_level = level - 1
        base_graph = StandardizedGraph()
        i1 = base_graph.add_vert(pos_x=-4, pos_y=0, level=prev_level, label="i")
        ...
        e5 = base_graph.add_vert(pos_x=0, pos_y=0, level=level, label="E")
        base_graph.add_edges([(i1, I1), (i1, I2), (i2, I3), (i2, I4)])
        base_graph.add_edges([(I1, e1), (I1, e5), (I2, e5), (I3, e1), (I3, e2), (I4, e2), (I4, e3)])
        base_graph.add_edges([(e1, e5), (e1, e2), (e2, e3)])
        e13 = base_graph.add_vert(pos_x=0, pos_y=1, level=prev_level, label="E")
        base_graph.add_edges([(e13, i1), (e13, i2)])
    ...
    def test_match_P8_correct_large(self):
        level = 1
        prev_level = level - 1
        base_graph = StandardizedGraph()
        i1 = base_graph.add_vert(pos_x=-4, pos_y=2, level=prev_level, label="i")
        i2 = base_graph.add_vert(pos_x=4, pos_y=2, level=prev_level, label="i")
        ...
        i3 = base_graph.add_vert(pos_x=-4, pos_y=-2, level=prev_level, label="i")
        i4 = base_graph.add_vert(pos_x=4, pos_y=-2, level=prev_level, label="i")
        ...
        base_graph.add_edges([(e1, e5), (e6, e5), (e1, e2), (e2, e3), (e7, e8), (e8, e9), (e10, e11), (e11, e12)])
        e13 = base_graph.add_vert(pos_x=0, pos_y=1, level=prev_level, label="E")
        base_graph.add_edges([(e13, i1), (e13, i2)])
        e14 = base_graph.add_vert(pos_x=0, pos_y=0, level=prev_level, label="E")
        ...
        expected_graph = StandardizedGraph()
        i1 = expected_graph.add_vert(pos_x=-4, pos_y=2, level=prev_level, label="i")
        i2 = expected_graph.add_vert(pos_x=4, pos_y=2, level=prev_level, label="i")
        ...
        i3 = expected_graph.add_vert(pos_x=-4, pos_y=-2, level=prev_level, label="i")
        i4 = expected_graph.add_vert(pos_x=4, pos_y=-2, level=prev_level, label="i")
        ...
        e13 = expected_graph.add_vert(pos_x=0, pos_y=1, level=prev_level, label="E")
        expected_graph.add_edges([(e13, i1), (e13, i2)])
        e14 = expected_graph.add_vert(pos_x=0, pos_y=0, level=prev_level, label="E")
    ...
    def test_match_P8_correct_too_much(self):
        level = 1
        prev_level = level - 1
        base_graph = StandardizedGraph()
        i1 = base_graph.add_vert(pos_x=-4, pos_y=0, level=prev_level, label="i")
        ...
        base_graph.add_edges([(i1, I1), (i1, I2), (i2, I3), (i2, I4)])
        base_graph.add_edges([(I1, e1), (I1, e5), (I2, e6), (I2, e5), (I3, e1), (I3, e2), (I4, e2), (I4, e3), (I4, e3_1), (I2, e6_1)])
        base_graph.add_edges([(e1, e5), (e6, e5), (e1, e2), (e2, e3), (e3_1, e3), (e6, e6_1)])
        e13 = base_graph.add_vert(pos_x=0, pos_y=1, level=prev_level, label="E")
        base_graph.add_edges([(e13, i1), (e13, i2)])
        ...
        e2 = expected_graph.add_vert(pos_x=0, pos_y=0, level=level, label="E")
        e3 = expected_graph.add_vert(pos_x=0, pos_y=-4, level=level, label="E")
        e3_1 = expected_graph.add_vert(pos_x=0, pos_y=-6, level=level, label="E")
        e6_1 = expected_graph.add_vert(pos_x=0, pos_y=-6, level=level, label="E")
        expected_graph.add_edges([(i1, I1), (i1, I2), (i2, I3), (i2, I4)])
