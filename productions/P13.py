...
def P13(graph: StandardizedGraph, v0_group: list, v1_group: list):
    ...
    if idx0 == 0:
        ...
        v1_vertices = [v0_group[0]] + [v1_group[0]]
...
def match_P13(graph: StandardizedGraph, level: int):
    matcher = SameCoordsMatcher(1,2)
