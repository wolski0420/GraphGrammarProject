...
class TestP6(unittest.TestCase):
    def test_match_P6_correct(self):
        ...
        i_match = match_P6(base_graph, level)[0]
        self.assertEqual(i_match, i1)

        new_graph = P6(base_graph, i_match)
        ...
        old_e8 = expected_graph.add_vert(pos_x=0, pos_y=-4, level=level, label="E")
        ...
        expected_graph.add_edges(
            [(old_e1, old_e6), (old_e2, old_e6), (old_e2, old_e7), (old_e3, old_e7), (old_e3, old_e8), (old_e8, old_e4), (old_e4, old_e5), (old_e5, old_e1)])
    ...
    def test_match_P6_incorrect_pos(self):
        level = 0
        base_graph = StandardizedGraph()
        e1 = base_graph.add_vert(pos_x=-4, pos_y=4, level=level, label="E")
        e2 = base_graph.add_vert(pos_x=4, pos_y=4, level=level, label="E")
    ...
    def test_match_P6_incorrect_missing(self):
        level = 0
        base_graph = StandardizedGraph()
        e1 = base_graph.add_vert(pos_x=-4, pos_y=4, level=level, label="E")
        e2 = base_graph.add_vert(pos_x=4, pos_y=4, level=level, label="E")
    ...
    def test_match_P6_incorrect_too_many(self):
        level = 0
        base_graph = StandardizedGraph()
        e1 = base_graph.add_vert(pos_x=-4, pos_y=4, level=level, label="E")
        e2 = base_graph.add_vert(pos_x=4, pos_y=4, level=level, label="E")
        ...
        e7 = base_graph.add_vert(pos_x=4, pos_y=0, level=level, label="E")
        e8 = base_graph.add_vert(pos_x=0, pos_y=-4, level=level, label="E")
        e9 = base_graph.add_vert(pos_x=-2, pos_y=-4, level=level, label="E")
        i1 = base_graph.add_vert(pos_x=0, pos_y=0, level=level, label="I")
        base_graph.add_edges([(e1, e6), (e2, e6), (e2, e7), (e3, e7), (e3, e8), (e8, e9), (e9, e4), (e4, e5), (e5, e1)])
        base_graph.add_edges([(i1, e1), (i1, e2), (i1, e3), (i1, e4)])
    ...
    def test_match_P6_correct_large(self):
        level = 0
        base_graph = StandardizedGraph()
        e1 = base_graph.add_vert(pos_x=-4, pos_y=4, level=level, label="E")
        e2 = base_graph.add_vert(pos_x=4, pos_y=4, level=level, label="E")
        ...
        e10 = base_graph.add_vert(pos_x=-12, pos_y=4, level=level, label="E")
        e11 = base_graph.add_vert(pos_x=-8, pos_y=-4, level=level, label="E")
        e12 = base_graph.add_vert(pos_x=-8, pos_y=4, level=level, label="E")
        e13 = base_graph.add_vert(pos_x=-12, pos_y=0, level=level, label="E")
        i2 = base_graph.add_vert(pos_x=-8, pos_y=0, level=level, label="I")
       
        base_graph.add_edges([(e1, e6), (e2, e6), (e2, e7), (e3, e7), (e3, e8), (e8, e4), (e4, e5), (e5, e1), (e4, e11), (e11, e9), (e9, e13), (e13, e10), (e10, e12), (e12, e1)])
        base_graph.add_edges([(i1, e1), (i1, e2), (i1, e3), (i1, e4)])
        base_graph.add_edges([(i2, e1), (i2, e4), (i2, e9), (i2, e10)])
        ...
        old_e10 = expected_graph.add_vert(pos_x=-12, pos_y=4, level=level, label="E")
        old_e11 = expected_graph.add_vert(pos_x=-8, pos_y=-4, level=level, label="E")
        old_e12 = expected_graph.add_vert(pos_x=-8, pos_y=4, level=level, label="E")
        old_e13 = expected_graph.add_vert(pos_x=-12, pos_y=0, level=level, label="E")
    ...
    def test_match_P6_incorrect_too_many_large(self):
        ...
        e7 = base_graph.add_vert(pos_x=4, pos_y=0, level=level, label="E")
        e8 = base_graph.add_vert(pos_x=0, pos_y=-4, level=level, label="E")
        e14 = base_graph.add_vert(pos_x=-4, pos_y=2, level=level, label="E")
        i1 = base_graph.add_vert(pos_x=0, pos_y=0, level=level, label="I")
        ...
        base_graph.add_edges([(e1, e6), (e2, e6), (e2, e7), (e3, e7), (e3, e8), (e8, e4), (e4, e5), (e5, e14), (e14, e1), (e4, e11), (e11, e9), (e9, e13), (e13, e10), (e10, e12), (e12, e1)])
        base_graph.add_edges([(i1, e1), (i1, e2), (i1, e3), (i1, e4)])
        base_graph.add_edges([(i2, e1), (i2, e4), (i2, e9), (i2, e10)])
    ...
    def test_match_P6_incorrect_pos_large(self):
        level = 0
        base_graph = StandardizedGraph()
        e1 = base_graph.add_vert(pos_x=-4, pos_y=4, level=level, label="E")
        e2 = base_graph.add_vert(pos_x=4, pos_y=4, level=level, label="E")
    ...
    def test_match_P6_incorrect_missing_large(self):
        level = 0
        base_graph = StandardizedGraph()
        e1 = base_graph.add_vert(pos_x=-4, pos_y=4, level=level, label="E")
        e2 = base_graph.add_vert(pos_x=4, pos_y=4, level=level, label="E")
        ...
        base_graph.add_edges([(e1, e6), (e2, e6), (e2, e7), (e3, e7), (e3, e8), (e8, e4), (e4, e1), (e4, e11), (e11, e9), (e9, e13), (e13, e10), (e10, e12), (e12, e1)])
        base_graph.add_edges([(i1, e1), (i1, e2), (i1, e3), (i1, e4)])
        base_graph.add_edges([(i2, e1), (i2, e4), (i2, e9), (i2, e10)])
