...
def P4(graph: StandardizedGraph, v: Vert):
    level = v.level()
    ...
    e13 = add_node_in_the_middle(graph, [e2, e3], level+1, "E")
    graph.add_edges([(e2, e13), (e3, e13)])
    e23 = add_node_in_the_middle(graph, [e1, e4], level+1, "E")
    graph.add_edges([(e1, e23), (e4, e23)])
    e24 = add_node_in_the_middle(graph, [e3, e4], level+1, "E")
    graph.add_edges([(e3, e24), (e4, e24)])

    e1234 = add_node_in_the_middle(graph, [e1, e2, e3, e4], level+1, "E")
    graph.add_edges([(e12, e1234), (e13, e1234), (e23, e1234), (e24, e1234)])

    i1 = add_node_in_the_middle(graph, [e1, e12, e23, e1234], level+1, "I")
    graph.add_edges([
        (i1, e1), (i1, e12), (i1, e23), (i1, e1234),
        (v, i1)
    ])

    i2 = add_node_in_the_middle(graph, [e2, e12, e13, e1234], level+1, "I")
    graph.add_edges([
        (i2, e2), (i2, e12), (i2, e13), (i2, e1234),
        (v, i2)
    ])

    i3 = add_node_in_the_middle(graph, [e4, e23, e24, e1234], level+1, "I")
    graph.add_edges([
        (i3, e4), (i3, e23), (i3, e24), (i3, e1234),
        (v, i3)
    ])

    i4 = add_node_in_the_middle(graph, [e3, e13, e24, e1234], level+1, "I")
    graph.add_edges([
        (i4, e3), (i4, e13), (i4, e24), (i4, e1234),
        (v, i4)
    ])
    return graph
...
def match_P4(graph: StandardizedGraph, level: int):
    matcher = SurroundingMatcher(2)
